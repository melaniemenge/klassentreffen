          ...
          <div className="border-t border-primary/20">
            ...
            {openAccordion === 4 && (
              <div className="px-4 sm:px-8 pb-4 sm:pb-8 text-base text-left">
                ...
                <p>Hier kannst du unserer WhatsApp-Gruppe beitreten: <a href={WHATSAPP_URL_OK} target="_blank" rel="noreferrer" className="text-primary underline">WhatsApp-Gruppe</a></p>
              </div>
            )}
          </div>
